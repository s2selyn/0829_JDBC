...
// 15:00
	...
	public Board selectBoard(int boardNo) { // Board 돌아가는건 확정이고 int 하나 받았음
		...
		// 1부터 시작인데 이거 막 이상한 숫자 0이하값 들어오면 갈 필요 없는데...(0, -1, -2 이런거 들어오면)
		// DB가면 돈드는데... 아까운데...
		// 언제만 가면 됨? 이렇게 하려면 얘도 미리 선언해놔야함
		Board board = null;
		
		// 그리고 이상한 값 안들어왔을때만 DB가면됨
		if(boardNo > 0) {
